...
import { cantileverOptimizer } from './cantilever-optimizer.js'

// Joist calculation functions

export function selectJoist(width, species, spacing, deckingType, beamStyle = 'drop', deckLength = null, optimizationGoal = 'cost', footingType = 'helical') {
...
export function getJoistSpanForBeamSelection(deckWidth, cantilever = 0) {
